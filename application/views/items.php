   ...
   <body class="hold-transition skin-blue  sidebar-mini">
    ...
    <!-- **********************MODALS END***************** -->
      ...
      <?php
         ...
         $sales_price=$purchase_price=$profit_margin=$unit_id=$price=$alert_qty=$lot_number=$wholesale_price="";
         $stock = 0;
         $expire_date ='';
         $description ='';
         $final_price ='';
                        ...
                        <div class="box-body">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <input type="text" class="form-control only_currency " id="wholesale_price" name="wholesale_price" placeholder="Wholesale Price"  value="<?php print $wholesale_price; ?>" >
